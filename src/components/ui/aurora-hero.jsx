  ...
  return <motion.section style={{
    backgroundImage
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="mt-6 mb-10 max-w-xl text-center text-base leading-relaxed text-muted-foreground md:text-lg md:leading-relaxed py-[50px]">
        ...
        scale: 0.985
      }} onClick={onButtonClick} className="group relative flex items-center justify-center w-fit rounded-full bg-background/10 px-8 py-3 text-foreground transition-colors hover:bg-background/20 backdrop-blur-sm">

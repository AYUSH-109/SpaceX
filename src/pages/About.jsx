...
const About = () => {
  ...
  return <div className="min-h-screen bg-background">
      <ShootingStars starColor="#9E00FF" trailColor="#2EB9DF" minSpeed={15} maxSpeed={35} />
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => <div key={index} className="bg-card border border-border rounded-lg p-6 hover:border-primary transition-colors">
